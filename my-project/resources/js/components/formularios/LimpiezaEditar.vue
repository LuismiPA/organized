<template>
    <div class="abs-center">
        <form class="centrado shadow p-3 mb-5 bg-body rounded" action="javascript:void(0)"
            @submit.prevent="editarLimpieza">
            <h1 class="mb-2">Editar Limpieza</h1>
            <div class="form-row">
            ...
            <button type="submit" class="btn btn-primary">Crear limpieza</button>
        </form>
    </div>
</template>
...
export default {
    ...
    methods: {
        editarLimpieza() {
            axios.put('/limpieza/crear', this.limpieza).then(response => console.log(response.data));
        }
    },
}
</script>